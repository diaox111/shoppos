  ...
  const map: Record<string, District[]> = {
    ...
    '天津': [
      { name: '和平区', areas: [
        ...
        { name: '五大道', desc: '文旅区', factor: 1.5 },
        { name: '小白楼', desc: '商务区', factor: 1.4 },
        { name: '居民区', desc: '住宅', factor: 1.1 },
      ]},
      { name: '南开区', areas: [
        { name: '大悦城/鼓楼', desc: '商圈', factor: 1.3 },
        { name: '古文化街/天后宫', desc: '景区', factor: 1.5 },
        { name: '水上公园/奥体', desc: '景区+商圈', factor: 1.3 },
        { name: '南开大学/天津大学', desc: '高校', factor: 1.0 },
        { name: '天拖/鞍山西道', desc: '科贸商圈', factor: 1.05 },
        { name: '居民区', desc: '住宅', factor: 1.0 },
      ]},
      { name: '河西区', areas: [
        { name: '文化中心/万象城', desc: '商圈', factor: 1.45 },
        { name: '梅江', desc: '高端社区', factor: 1.2 },
        { name: '小白楼/大营门', desc: '商务区', factor: 1.35 },
        { name: '新八大里', desc: '新兴商圈', factor: 1.15 },
        { name: '居民区', desc: '住宅', factor: 1.05 },
      ]},
      { name: '河东区', areas: [
      ...
      { name: '西青区', areas: [
        { name: '中北镇/永旺', desc: '商圈', factor: 1.05 },
        { name: '大学城（工大/师大/理工）', desc: '高校', factor: 0.85 },
        { name: '张家窝/南站', desc: '交通枢纽', factor: 1.0 },
        { name: '居民区', desc: '住宅', factor: 0.9 },
      ]},
      { name: '津南区', areas: [
      ...
      { name: '武清区', areas: [
        { name: '佛罗伦萨小镇', desc: '商圈', factor: 1.25 },
        { name: '万达商圈', desc: '商圈', factor: 1.0 },
        { name: '城区', desc: '普通', factor: 0.85 },
      ]},
      { name: '滨海新区', areas: [
        { name: '于家堡/响螺湾', desc: 'CBD', factor: 1.3 },
        { name: '泰达/TEDA', desc: '商务区', factor: 1.25 },
        { name: '塘沽/金街', desc: '商圈', factor: 1.15 },
        { name: '生态城', desc: '新型社区', factor: 1.0 },
        { name: '东疆湾', desc: '景区', factor: 1.4 },
        { name: '居民区', desc: '住宅', factor: 0.9 },
      ]},
      { name: '蓟州区', areas: [
