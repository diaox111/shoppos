...
function cityDistricts(city: string): District[] {
  const map: Record<string, District[]> = {
    ...
    '天津': [
      ...
      { name: '河西区', areas: [
        { name: '文化中心', desc: '商圈', factor: 1.4 },
        { name: '居民区', desc: '住宅', factor: 1.05 },
      ]},
      { name: '南开区', areas: [
        { name: '南开大学/天津大学', desc: '高校', factor: 1.0 },
        { name: '鼓楼/古文化街', desc: '景区', factor: 1.5 },
        { name: '大悦城商圈', desc: '商圈', factor: 1.3 },
        { name: '居民区', desc: '住宅', factor: 1.0 },
      ]},
      { name: '滨海新区', areas: [
        { name: '于家堡/TEDA', desc: '商务区', factor: 1.3 },
        { name: '东疆湾', desc: '景区', factor: 1.4 },
        { name: '居民区', desc: '住宅', factor: 0.9 },
      ]},
      { name: '蓟州区', areas: [
        { name: '盘山/黄崖关', desc: '景区', factor: 1.4 },
